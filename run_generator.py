...
Run 'python %(prog)s <subcommand> --help' for subcommand help.''',
    ...
    parser_truncation_traversal.add_argument('--result-dir',
    ...
    parser_generate_latent_walk.add_argument('--network', help='Network pickle filename', dest='network_pkl',
                                             required=True)
    parser_generate_latent_walk.add_argument('--truncation-psi', type=float,
    ...
    parser_generate_latent_walk.add_argument('--frames', type=int, help='Frame count (default: %(default)s',
                                             default=240)
    ...
    parser_generate_latent_walk.add_argument('--start_seed', type=int, help='random seed to start noise loop from',
                                             default=0)
    parser_generate_latent_walk.add_argument('--result-dir',
                                             help='Root directory for run results (default: %(default)s)',
                                             default='results', metavar='DIR')
